<template>
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header"><h4 class="card-title">Preperences</h4></div>
                <div class="card-body">
                    <form action="">
                        <div class="form-row">
                        ...
                        <div class="form-row col-6">
                            <div class="form-group mb-0">
                                <label class="toggle"
                                    ...
                                    <span class="toggle-label">I send or receive digital currency</span></label
                                >
                                <label class="toggle"
                                    ><input type="checkbox" class="toggle-checkbox" />
                                    <div class="toggle-switch"></div>
                                    <span class="toggle-label">I receive merchant order</span></label
                                >
                                <label class="toggle"
                                    ><input type="checkbox" class="toggle-checkbox" />
                                    <div class="toggle-switch"></div>
                                    <span class="toggle-label">There are recommendation for my sccount</span></label
                                >
                            </div>
